        ...
        <div className="absolute bottom-6 left-6 right-6">
          <div className="flex items-center space-x-3 p-3 rounded-lg bg-slate-100 dark:bg-slate-700">
            ...
            <div className="flex-1 min-w-0">
              <p className="font-medium text-slate-900 dark:text-white truncate">John Smith</p>
              <p className="text-sm text-slate-500 dark:text-slate-400 truncate">Financial Advisor</p>
            </div>
          </div>
        </div>
      </div>
